...
public class Bullets implements ContentList{
    ...
    //liquid
    waterShot, cryoShot, slagShot, oilShot, supercoolantShot, heavyWaterShot, heavyCryoShot, heavySlagShot, heavyOilShot, heavySupercoolantShot,
    ...
    public void load(){
        ...
        supercoolantShot = new LiquidBulletType(Liquids.supercoolant){{
            drag = 0.01f;
        }};
        ...
        heavySupercoolantShot = new LiquidBulletType(Liquids.supercoolant){{
            lifetime = 49f;
            speed = 4f;
            knockback = 1.3f;
            puddleSize = 8f;
